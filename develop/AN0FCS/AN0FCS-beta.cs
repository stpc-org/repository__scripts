...
class Target
{
	...
	public Vector3D a { get; private set; } public Vector3D a_a { get; private set; }//瞬时加速度和平均加速度
	public Vector3D p { get; private set; } public double d { get; private set; }//位置, 距离
...
static class TK
{
	...
	{
		bool res = false; if(t==0) { t=p; res=true; } --t; return res;
	}
